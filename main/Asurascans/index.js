...
},{"./named-references":4,"./numeric-unicode-map":5,"./surrogate-pairs":6}],4:[function(require,module,exports){
...
},{"./models/impl_export":84}],9:[function(require,module,exports){
"use strict";
/**
...
},{"./APIWrapper":8,"./base":11,"./models":85}],13:[function(require,module,exports){
...
},{"./Button/_impl":18,"./Form/_impl":20,"./Header/_impl":23,"./InputField/_impl":25,"./Label/_impl":27,"./Link/_impl":29,"./MultilineLabel/_impl":31,"./NavigationButton/_impl":33,"./OAuthButton/_impl":35,"./Section/_impl":37,"./Select/_impl":39,"./Stepper/_impl":41,"./Switch/_impl":43,"./WebViewButton/_impl":45}],48:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });
...
},{"./Button":19,"./Form":21,"./FormRow":22,"./Header":24,"./InputField":26,"./Label":28,"./Link":30,"./MultilineLabel":32,"./NavigationButton":34,"./OAuthButton":36,"./Section":38,"./Select":40,"./Stepper":42,"./Switch":44,"./WebViewButton":46}],49:[function(require,module,exports){
(function (global){(function (){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const _global = global;
...
},{"axios":"axios","buffer":2}],65:[function(require,module,exports){
arguments[4][14][0].apply(exports,arguments)
...
},{"./Chapter/_impl":13,"./ChapterDetails/_impl":15,"./DynamicUI/impl_export":47,"./HomeSection/_impl":49,"./Manga/_impl":52,"./MangaTile/_impl":54,"./MangaUpdate/_impl":56,"./PagedResults/_impl":58,"./RawData/_impl":60,"./RequestManager/_impl":64,"./RequestObject/_impl":66,"./SearchField/_impl":69,"./SourceManga/_impl":73,"./SourceStateManager/_impl":75,"./TagSection/_impl":78,"./TrackedManga/_impl":80}],85:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });
...
},{"./Chapter":14,"./ChapterDetails":16,"./Constants":17,"./DynamicUI":48,"./HomeSection":50,"./Languages":51,"./Manga":53,"./MangaTile":55,"./MangaUpdate":57,"./PagedResults":59,"./RawData":61,"./RequestHeaders":62,"./RequestInterceptor":63,"./RequestManager":65,"./RequestObject":67,"./ResponseObject":68,"./SearchField":70,"./SearchRequest":71,"./SourceInfo":72,"./SourceManga":74,"./SourceStateManager":76,"./SourceTag":77,"./TagSection":79,"./TrackedManga":81,"./TrackedMangaChapterReadAction":82,"./TrackerActionQueue":83}],86:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.isLastPage = exports.parseViewMore = exports.parseHomeSections = void 0;
...
const parseViewMore = (source, $) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const item of $('a', 'div.grid.grid-rows-1').toArray()) {
        ...
        const image = (_d = $('img', item).first().attr('src')) !== null && _d !== void 0 ? _d : '';
        const title = (_e = $('span.block.font-bold', item).first().text().trim()) !== null && _e !== void 0 ? _e : '';
        const subtitle = (_f = $('span.block.font-bold', item).first().next().text().trim()) !== null && _f !== void 0 ? _f : '';
        ...
        manga.push(createMangaTile({
            ...
            image: image,
            title: {
                text: (0, html_entities_1.decode)(title)
            },
            subtitleText: {
                text: (0, html_entities_1.decode)(subtitle)
            }
        }));
...
},{"html-entities":3,"paperback-extensions-common":12}],87:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
class Asurascans extends paperback_extensions_common_1.Source {
    ...
    getViewMoreItems(homepageSectionId, metadata) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.requestManager.schedule(request, 1);
            const $ = this.cheerio.load(response.data);
            const manga = yield (0, AsuraParser_1.parseViewMore)(this, $);
            metadata = !(0, AsuraParser_1.isLastPage)($) ? { page: page + 1 } : undefined;
...
},{"./AsuraParser":86,"paperback-extensions-common":12}]},{},[87])(87)
});
